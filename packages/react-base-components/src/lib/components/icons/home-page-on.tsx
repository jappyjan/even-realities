...
export interface HomePageOnIconProps extends Omit<IconBaseProps, 'viewBox'> {}

export const HomePageOnIcon = React.forwardRef<SVGSVGElement, HomePageOnIconProps>(
  ({ title, ...props }, ref) => (
...
HomePageOnIcon.displayName = 'HomePageOnIcon';
